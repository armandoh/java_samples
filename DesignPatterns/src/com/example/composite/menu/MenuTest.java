...
public class MenuTest {
    ...
    public static void main(String[] args) {
        ...
        dessertMenu.add(new MenuItem("Apple Pie", "Apple pie with a flakey cruse, topped with vanilla icecream", true, 1.59));
        dessertMenu.add(new MenuItem("Cheesecake", "Creamy New York cheesecake, with a chocolate graham crust", true, 1.99));
        dessertMenu.add(new MenuItem("Serbet", "A scoop of raspberry and scoop of lime", true, 1.89));
